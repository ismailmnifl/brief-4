		...
		<div class="tables">
            ...
            <input type="hidden" name="id" value="<?php echo $id; ?>">
				...
				<div class=" radio input-group">
                    <label>Etudiant : <input class="radiobutton" type="radio" name="selection" checked value="etudiant"></label>
                    
					<label>Formateur : <input class="radiobutton" type="radio" name="selection"  value="formateur"></label>
